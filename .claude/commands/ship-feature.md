...
Good: "feat: add delete expense button with confirmation dialog" Bad: "feat: added DELETE route to app.py"
...
Title: plain English feature name, no conventional commit prefix Example: "Add delete expense functionality"
...
Final summary
Print: ╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌ /ship-feature complete ✓ Committed — ✓ Pushed — ✓ PR created and merged ✓ Remote branch deleted ✓ Switched to main ✓ Local branch deleted Next: run /create-spec for the next feature ╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌
